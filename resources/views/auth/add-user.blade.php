...
<div class="content">
  <form action="{{url('/admin/store-user')}}" method="post" id="add_User" enctype="multipart/form-data">
    @csrf
    <div class="content">
        ...
        <div class="row">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea id="editor" rows="4" cols="80" class="form-control" placeholder="User Information here" name="info">{{old('info')}}</textarea>
                      @if($errors->has('info'))
          ...
          <div class="col-md-4">
            <div class="card card-user">
              <div class="card-image"> <img src="{{old('image')}}" id="output"> </div>
              <div class="card-body">
              ...
              <br>
              <input type="file" class="form-control btn btn-primary" value="{{old('image')}}" name="image" id="image" accept="image/*" onChange="document.getElementById('output').src = window.URL.createObjectURL(this.files[0])">
            </div>
          </div>
        </div>
      </div>
